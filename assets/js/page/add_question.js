        ...
        if (testI == ''){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    showModal();
                    $("#loader").modal("show");
                    $.post("queries/add_exam.php", { exam_title:title, exam_div:division, hours:hour, minute:minutes, second:seconds, test_number:test_num}, function (exam){
                        hideModal();
                        $("#loader").modal("hide");
                        if (exam == 1){
                            $.post("queries/add_exam_test.php", {exam_title:title, test_1:testI, test_2:testII, test_3:testIII, test_4:testIV, test_5:testV}, function (test){
                                if (test == 1){
                                    iziToast.success({
                                        ...
                                        progressBarColor: 'rgb(28,61,119)',
                                        onClosing: function(){
