            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active">Departments</div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="section-title mt-0 d-inline">DEPARTMENTS</h4>
                                    <div class="card-header-action">
                                        <div id="active_button_container">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary btnAddDepartment" >
                                                    <i class='fas fa-plus'></i>&nbsp;
                                                    Add
                                                </button>
                                                <button type='button' class='btn btn-sm btn-danger btnDelAllDept' disabled>
                                        ...
                                        <div id="trash_button_container">
                                                <button type='button' class='btn btn-sm btn-primary btnRestoreAllDepartment' disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-12 ">
                                            <ul class="list-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <li class="list-group-item p-3 mb-3">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label class="col text-md-left text-left" for="AccSel"> Account Status: </label>
                                                                        <div class="col text-md-left">
                                                                            <select id="AccSel" class="form-control" required>
                                                                                <option value="">Select Status</option>
                                                                                <option value="=">No Account</option>
                                                                                <option value=">">With Account</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label class="col text-md-left text-left" for="WDivSel"> Division Status: </label>
                                                                        <div class="col text-md-left">
                                                                            <select id="WDivSel" class="form-control" required>
                                                                                <option value="">Select Status</option>
                                                                                <option value="=">No Division</option>
                                                                                <option value=">">With Division</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row" id="department_active">
                                                    <div class="col-lg-12">
                                                        <li class="list-group-item p-3 mb-3">
                                                ...
                                                <div class="row" id="department_deleted">
                                                    <div class="col-lg-12">
                                                        <li class="list-group-item p-3 mb-3">
                                                            <div id="department_deleted_list">
                                                            </div>
                                                        </li>
                                                    </div>
                                                </div>
...
<script src="../../assets/js/page/main_list_department.js"></script>
