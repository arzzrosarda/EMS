...
<table class="table table-sm" id="rlog">
    ...
    if (isset($_REQUEST['department'])){
        ...
        $userQuery = $conn->query("SELECT * FROM user WHERE usertype = 'examinee' AND department = '$department' AND isDelActive = '0'");
    }
    else {
        $userQuery = $conn->query("SELECT * FROM user WHERE usertype = 'examinee' AND isDelActive = '0'");
    }
