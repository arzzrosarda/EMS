...
<div class="table-responsive">
    <table class="table table-sm" id="ulog">
        ...
        if (isset($_REQUEST['department'])){
            ...
            $userQuery = $conn->query("SELECT * FROM user WHERE usertype = 'examinee' AND department = '$department' AND isDelActive = '1'");
        }
        else {
            $userQuery = $conn->query("SELECT * FROM user WHERE usertype = 'examinee' AND isDelActive = '1'");
        }
