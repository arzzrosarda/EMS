            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active">List of Examinees</div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="section-title mt-0 d-inline">LIST OF EXAMINEES</h4>
                                    <div class="card-header-action">
                                        <div id="active_examinee_container">
                                            <button class='btn btn-sm btn-danger btnViewDel' disabled>
                                                <i class='fas fa-trash-alt' aria-hidden='true'></i>&nbsp;
                                                Delete
                                            </button>
                                        </div>
                                        <div id="deleted_examinee_container">
                                            <button class='btn btn-sm btn-info btnRestoreAllUser' disabled>
                                ...
                                <div class="card-body" >
                                    <ul class="list-group">
                                            ...
                                            <div class="col-lg-10">
                                                <li class="list-group-item p-3 mb-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label class="col text-md-left text-left" for="diviselect">Department: </label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class="col text-md-left text-left" for="status_sel">Division: </label>
                                        ...
                                        <div class="row" id="list_examinee">
                                            <div class="col-lg-12">
                                                <li class="list-group-item p-3 mb-3">
                                                    <div id="list-of-examinee">
                                                    </div>
                                                </li>
                                            </div>
                                        </div>
                                        <div class="row" id="list_deleted_examinee">
                                            <div class="col-lg-12">
                                                <li class="list-group-item p-3 mb-3">
                                                    <div id="list-of-deluser">
                                                    </div>
                                                </li>
                                            </div>
                                        </div>
...
<script src="../../assets/js/page/main_list_examinee.js"></script>
