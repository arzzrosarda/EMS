            ...
            <section class="section">
                ...
                <div class="section-body" id="dashboard">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card card-statistic-1">
                                <div class="card-icon" style="background: #0f7b9f;">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body" id="total_department">
                        ...
                        <div class="col-lg-4">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body" id="total_exams">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                            <div class="card p-2" style="height: 79vh;">
                                <div class="card-header">
                                ...
                                <div class="card-body" style="overflow: auto;">
                                    <div id="filter_container">
                                        <div class="row pb-3 filter" id="filter1"  style="display: none;">
                                            <div class="col">
                                                <select id="depselect1" class="form-control">
                                            ...
                                            <div class="col">
                                                <select id="divselect1" class="form-control" disabled>
                        ...
                        <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                            <div class="row">
                                <div class="col-6">
                                    <div class="card p-2" style="height: 38vh;">
                                        <div class="card-header">
                                            <h4 class="d-inline">Examinees</h4>
                                            <div class="card-header-action">
                                                <div class="btn-group">
                                ...
                                <div class="col-6">
                                    <div class="card p-2" style="height: 38vh;">
                                        <div class="card-header">
                                            <h4 class="d-inline">Departments</h4>
                                            <div class="card-header-action">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-primary btnAddDepartment"><i class="fas fa-plus"></i> Add</button>
                                                    <a href="list_department.php" class="btn btn-primary">View All</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body" style="overflow: auto;" id="dept_list">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card pb-3">
                                        <div class="card-header">
                                            <label> No. of user per department from <label id="start_year"></label> to <label id="curr_year"></label></label>
                                        </div>
                                        <div class="card-body " id="chart_log">
                                ...
                                <div class="col-6">
                                    <div class="card p-2" style="height: 38vh">
                                        <div class="card-header">
                                            ...
                                            <div class="card-header-action">
                                                <button type="button" class="btn btn-primary btn-icon btn-round" id="filter-btn2"><i class="fas fa-filter"></i> Filter</button>
                                            </div>
                                        </div>
                                        <div class="card-body" style="overflow: auto">
                                            <div id="filter_container">
                                                <div class="row pb-3 filter" id="filter2"  style="display: none;">
                                                    <div class="col">
                                                        <select id="depselect2" class="form-control" autofocus>
                                                            <option value="">All Department</option>
                                                            <?php
                                                            $department_query = $conn->query("SELECT * FROM department");
                                                            while ($department = $department_query->fetch()){ ?>
                                                    ...
                                                    <div class="col">
                                                        <select id="divselect2" class="form-control" disabled >
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body " id="staff_log">
...
<script src="../../assets/js/page/main_admin.js"></script>
