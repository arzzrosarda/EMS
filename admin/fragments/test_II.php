...
if (isset($_POST['exam_id'])){
    ...
    $res .= '<script>
                $(document).ready(function (){
                   $("#inputII_btn_W").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputII_W").val();
                        var qtype = "'. $test_II .'";
                        Swal.fire({
                                      ...
                                      if (wi == 1){
                                            $.post("modal/loader.php", function(load){
                                               $("#test2_form").html(load);
                                                  $.post("fragments/test_II.php", {exam_id:' . $exam_id . '}, function(test2){
                                                       $("#test2_form").html(test2);
                                                  });
                                            });
                                      }else if (wi == 3){
                                          $("#inputII_W").focus();
                   ...
                   $("#inputII_btn_WO").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputII_WO").val();
                        var qtype = "'. $test_II .'";
                        Swal.fire({
               ...
               <input class="form-control" type="hidden" value="'. $test_II .'" name="question_type">';
                                if ($test_II == 'Multiple Choice'){
                                    echo '<div class="col-xl-12 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-body row">
                                                    <h6 id="testII_title" class="col-md-5"> TITLE </h6>
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            <input class="form-control" type="number" min="0" id="inputII_W">
                                                            <button type="button" class="btn btn-primary" id="inputII_btn_W">
                                                                With Image
                                                            </button>
                                                                &nbsp;&nbsp;
                                                            <input class="form-control" type="number" min="0" id="inputII_WO">
                                                            <button type="button" class="btn btn-primary" id="inputII_btn_WO">
                                                                Without Image
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            ...
                                                            <button type="button" class="btn btn-primary" id="inputII_btn">Add Question</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $question_option_query = $conn->query("SELECT a.`id` AS question_no, a.`points`, a.`question_type`, a.`question`,
                                                 ...
                                                 WHERE q_id = '$exam_id' AND o_id = '$exam_id' AND a.`question_type` = '$test_II'");
    $index = 1;
    $title = 1;
