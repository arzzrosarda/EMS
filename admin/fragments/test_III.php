...
if (isset($_POST['exam_id'])){
    ...
    $res .= '<script>
                $(document).ready(function (){
                   $("#inputIII_btn_W").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputIII_W").val();
                        var qtype = "'. $test_III .'";
                        Swal.fire({
                                      ...
                                      if (wi == 1){
                                            $.post("modal/loader.php", function(load){
                                               $("#test3_form").html(load);
                                                  $.post("fragments/test_III.php", {exam_id:' . $exam_id . '}, function(test3){
                                                    $("#test3_form").html(test3);
                                                  });
                                            });
                                      }else if (wi == 3){
                                          $("#inputIII_W").focus();
                   ...
                   $("#inputIII_btn_WO").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputIII_WO").val();
                        var qtype = "'. $test_III .'";
                        Swal.fire({
                   ...
                   $("#inputIII_btn").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#input_III").val();
                        var qtype = "'. $test_III .'";
                        Swal.fire({
                          title: "ADD QUESTION",
               ...
               <input class="form-control" type="hidden" value="'. $test_III .'" name="question_type">';
                                if ($test_III == 'Multiple Choice'){
                                    echo '<div class="col-xl-12 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-body row">
                                                    <h6 id="testIII_title" class="col-md-5"> TITLE </h6>
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            <input class="form-control" type="number" min="0" id="inputIII_W">
                                                            <button type="button" class="btn btn-primary" id="inputIII_btn_W">
                                                                With Image
                                                            </button>
                                                                &nbsp;&nbsp;
                                                            <input class="form-control" type="number" min="0" id="inputIII_WO">
                                                            <button type="button" class="btn btn-primary" id="inputIII_btn_WO">
                                                                Without Image
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    echo '<div class="col-xl-12 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            <input class="form-control" type="number" min="0" id="input_III">
                                                            <button type="button" class="btn btn-primary" id="inputIII_btn">Add Question</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $question_option_query = $conn->query("SELECT a.`id` AS question_no, a.`points`, a.`question_type`, a.`question`,
                                                 ...
                                                 WHERE q_id = '$exam_id' AND o_id = '$exam_id' AND a.`question_type` = '$test_III'");
    $index = 1;
    $title = 1;
    while($qo = $question_option_query->fetch()){
        ...
        if ($test_III == "Multiple Choice"){
            ...
            $res .= '<div class="card-body row">
                        <div class="form-group row align-items-center">
                        <input type="hidden" class="form-control" id="multiple_image_container' . $qo['option_id'] . '" name="complete" required> 
                            <label class="col-xl-10 text-md-right text-left">Points: <label style="color:red;">*</label></label>
                            <div class="col-xl-2 col-md-6">
                                <input type="number" name="points_' . $qo['option_id'] . '"class="form-control" min="0" value="'. $qo['points'] .'" required>
                            </div>
