...
if (isset($_POST['exam_id'])){
    ...
    $res .= '<script>
                $(document).ready(function (){
                   $("#inputV_btn_W").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputV_W").val();
                        var qtype = "'. $test_V .'";
                        Swal.fire({
                                      ...
                                      if (wi == 1){
                                            $.post("modal/loader.php", function(load){
                                               $("#test5_form").html(load);
                                                  $.post("fragments/test_V.php", {exam_id:' . $exam_id . '}, function(test){
                   ...
                   $("#inputV_btn_WO").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputV_btn_WOO").val();
                        var qtype = "'. $test_V .'";
                        Swal.fire({
               ...
               <input class="form-control" type="hidden" value="'. $test_V .'" name="question_type">';
                                if ($test_V == 'Multiple Choice'){
                                    echo '<div class="col-xl-12 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-body row">
                                                    <h6 id="testV_title" class="col-md-5"> TITLE </h6>
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            <input class="form-control" type="number" min="0" id="inputV_W">
                                                            <button type="button" class="btn btn-primary" id="inputV_btn_W">
                                                                With Image
                                                            </button>
                                                                &nbsp;&nbsp;
                                                            <input class="form-control" type="number" min="0" id="inputV_btn_WOO">
                                                            <button type="button" class="btn btn-primary" id="inputV_btn_WO">
                                                                Without Image
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    echo '<div class="col-xl-12 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            <input class="form-control" type="number" min="0" id="input_V">
                                                            <button type="button" class="btn btn-primary" id="inputV_btn">Add Question</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $question_option_query = $conn->query("SELECT a.`id` AS question_no, a.`points`, a.`question_type`, a.`question`,
                                                 ...
                                                 WHERE q_id = '$exam_id' AND o_id = '$exam_id' AND a.`question_type` = '$test_V'");
    $index = 1;
    $title = 1;
