...
if (isset($_POST['exam_id'])){
    ...
    $res .= '<script>
                $(document).ready(function (){
                   $("#inputIV_btn_W").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputIV_W").val();
                        var qtype = "'. $test_IV .'";
                        Swal.fire({
                                      ...
                                      if (wi == 1){
                                            $.post("modal/loader.php", function(load){
                                               $("#test4_form").html(load);
                                                  $.post("fragments/test_IV.php", {exam_id:' . $exam_id . '}, function(test){
                   ...
                   $("#inputIV_btn_WO").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#inputIV_btn_WOO").val();
                        var qtype = "'. $test_IV .'";
                        Swal.fire({
                   ...
                   $("#inputIV_btn").click(function (){
                        var exam_id = "'. $exam_id .'";
                        var num = $("#input_IV").val();
                        var qtype = "'. $test_IV .'";
                        Swal.fire({
                          title: "ADD QUESTION",
               ...
               <input class="form-control" type="hidden" value="'. $test_IV .'" name="question_type">';
                                if ($test_IV == 'Multiple Choice'){
                                    echo '<div class="col-xl-12 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-body row">
                                                    <h6 id="testIV_title" class="col-md-5"> TITLE </h6>
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            <input class="form-control" type="number" min="0" id="inputIV_W">
                                                            <button type="button" class="btn btn-primary" id="inputIV_btn_W">
                                                                With Image
                                                            </button>
                                                                &nbsp;&nbsp;
                                                            <input class="form-control" type="number" min="0" id="inputIV_btn_WOO">
                                                            <button type="button" class="btn btn-primary" id="inputIV_btn_WO">
                                                                Without Image
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    echo '<div class="col-xl-12 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-md-7 text-md-right text-right mt-2">
                                                        <div class="btn-group">
                                                            <input class="form-control" type="number" min="0" id="input_IV">
                                                            <button type="button" class="btn btn-primary" id="inputIV_btn">Add Question</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $question_option_query = $conn->query("SELECT a.`id` AS question_no, a.`points`, a.`question_type`, a.`question`,
                                                 ...
                                                 WHERE q_id = '$exam_id' AND o_id = '$exam_id' AND a.`question_type` = '$test_IV'");
    $index = 1;
    $title = 1;
