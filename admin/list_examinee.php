            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active">Examinees</div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="section-title mt-0 d-inline">EXAMINEES MONITORING</h4>
                                    <div class="card-header-action">
                                        <div id="examinee_list">
                                                <button class='btn btn-sm btn-danger btnViewDel' type="button" disabled>
                                                    <i class='fas fa-trash-alt' aria-hidden='true'></i>&nbsp;
                                                    Delete
                                                </button>
                                        </div>
                                        <div id="deleted_examinee">
                                                <button class='btn btn-sm btn-info btnRestoreAllUser' type="button" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-12 ">
                                            <ul class="list-group">
                                                ...
                                                <div class="row" id="active_examinee_list">
                                                    <div class="col-lg-12">
                                                        <li class="list-group-item p-3 mb-3">
                                                ...
                                                <div class="row" id="deleted_examinee_list">
                                                    <div class="col-lg-12">
                                                        <li class="list-group-item p-3 mb-3">
                                                            <div id="examinee_list_deleted">
                                                            </div>
                                                        </li>
                                                    </div>
                                                </div>
...
<script src="../assets/js/page/list_examinee.js"></script>
