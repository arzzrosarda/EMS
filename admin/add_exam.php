                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="add_exam.php" id="exam-link" >Create Exam</a></li>
                    ...
                    if (isset($_REQUEST['exam_id'])){
                        ...
                        <script>
                            $(document).ready(function (){
                                $("#divselect").val("<?php echo $division; ?>");
                                var time = $("#time").val();
                                            ...
                                            <div class="wizard-pane">
                                                <div class="form-group row align-items-center">
                                                    ...
                                                    <div class="col-lg-7 col-md-6">
                                                        <input type="hidden" name="txt_department" class="form-control" value="<?php echo $department; ?>">
                                                ...
                                                <div class="form-group row align-items-center">
                                                    ...
                                                    <div class="col-lg-7 col-md-6">
                                                        <select id="divselect" name="division" class="form-control">
                                        ...
                                        <div class="wizard-content mt-auto" id="examdetailstab">
                                            <div class="wizard-pane">
                                                ...
                                                <div class="form-group row align-items-center">
                                                    <label class="col-md-3 text-md-right text-left" for="divselect">Division <label style="color:red;">*</label></label>
                                                    <div class="col-lg-7 col-md-6">
                                                        <select id="divselect" class="form-control" required>
                                                            <option value="">Select Division</option>
                                                            <?php
                                                            $division_query = $conn->query("SELECT a.`id`, a.`department`, b.`department_id`, b.`division` FROM department a LEFT JOIN division b ON a.`id` = b.`department_id` WHERE a.`department` = '$department'");
                                                            while ($division = $division_query->fetch()){?>
...
<script src="../assets/js/page/add_exam.js"></script>
